...
#import views
#from first import user_log
#from ururu import user_pwd
#import form
id_user="5864007"
#email_user="2garin7@gmail.com"
#password_user="DINAMOkiev1927"
...
class VKAuth(object):
    ...
    def __init__(self, permissions = 'messages', app_id =id_user, api_v = "5.62", email='', pswd='', two_factor_auth=False, security_code= None, auto_access=True):
        """
        @args:
