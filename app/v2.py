...
id_user="5864007"
email_user= session ['user_login']
pasword_user=session ['user_password']
...
class VKAuth(object):
    ...
    def __init__(self, permissions = "notify,friends,photos,audio,video,docs,notes,pages,status,offers,questions,wall,groups,mail,messages,notifications,stats,ads,offline", app_id =id_user, api_v = "5.62", email=email_user, pswd=pasword_user, two_factor_auth=False, security_code= None, auto_access=True):
        """
        @args:
